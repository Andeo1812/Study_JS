...
let str = "hello";
let str2 = 'Оfasfawf';
let phrase = `data is - ${str}`;

let name = "Ivan";
// Вставим переменную
alert( `hello, ${name}!` ); // Привет, Иван!

// Вставим выражение
alert( `res: ${1 + 2}` ); // результат: 3
...
//
//  1 number для целых и вещественных чисел,
//  2 bigint для работы с целыми числами произвольной длины,
//  3 string для строк,
//  4 boolean для логических значений истинности или ложности: true/false,
//  5 null – тип с единственным значением null, т.е. «пустое значение» или «значение не существует»,
//  6 undefined – тип с единственным значением undefined, т.е. «значение не задано»,
//  7 object и symbol – сложные структуры данных и уникальные идентификаторы; их мы ещё не изучили.
